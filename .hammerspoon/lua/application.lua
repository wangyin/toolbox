-- 应用切换
hs.hotkey.bind({ "ctrl" }, "f", "Firefox", function()
    toggleAppByBundleId("org.mozilla.firefox")
end)
hs.hotkey.bind({ "ctrl" }, "g", "Chrome", function()
    toggleAppByBundleId("com.google.Chrome")
end)
hs.hotkey.bind({ "ctrl" }, "i", "wezterm", function()
    toggleAppByBundleId("com.github.wez.wezterm")
    -- toggleAppByBundleId("com.googlecode.iterm2")
end)
hs.hotkey.bind({ "alt" }, "m", "Mail", function()
    toggleAppByBundleId("com.microsoft.Outlook")
end)
hs.hotkey.bind({ "ctrl" }, "m", "Slack", function()
    toggleAppByBundleId("com.tinyspeck.slackmacgap")
end)
hs.hotkey.bind({ "ctrl" }, "q", "Quip", function()
    toggleAppByBundleId("com.quip.Desktop")
end)
hs.hotkey.bind({ "ctrl" }, "o", "VS Code", function()
...
function setMouseToWinCenter(mainWindow)
    if not mainWindow then
        return
    end
    local mainFrame = mainWindow:frame()
